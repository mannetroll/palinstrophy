...
class MainWindow(QMainWindow):
    def __init__(self, sim: DnsSimulator, steps: str, update: str, iterations: int, mov: int = 0) -> None:
        ...
        self.n_combo.addItems(
            ["128", "192", "256", "384", "512", "768", "1024", "1536", "2048", "3072", "4096", "6144", "7776",
             "8192", "9216", "10368", "11664", "12288", "16384", "18432", "20480", "24576", "32768", "34560"]
        )
        ...
        self.steps_combo.addItems(["10", "100", "1000", "2000", "5000", "10000", "20000", "50000",
                                   "1E5", "2E5", "3E5", "1E6", "1E7"])
    ...
    def _update_image(self, pixels: np.ndarray, *, display_scaled: bool = False) -> None:
        ...
        # Compose normalization with the indexed colour palette. Each displayed
        ...
        qimg.setColorTable([table[index] for index in lut])
